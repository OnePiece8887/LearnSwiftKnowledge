...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LSDObjcSugar/LSDObjcSugar.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TFYSwiftTabbarKit/TFYSwiftTabbarKit.framework"
