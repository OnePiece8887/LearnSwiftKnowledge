...
- (void)selectedOk
{
    if ([self.delegate respondsToSelector:@selector(pickerSingle:selectedTitle:selectedIndex:)]) {
        [self.delegate pickerSingle:self selectedTitle:self.selectedTitle selectedIndex:self.selectIndex];
    }
