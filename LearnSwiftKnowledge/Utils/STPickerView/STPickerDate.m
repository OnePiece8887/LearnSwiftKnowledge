...
//    self.title = @"请选择日期";
    ...
    NSString *text = [NSString stringWithFormat:@"%zd%02zd%02zd", _year, _month, _day];
    self.title = text;
...
- (void)reloadData
{
    ...
    NSString *text = [NSString stringWithFormat:@"%zd%02zd%02zd", self.year, self.month, self.day];
    self.title = text;
}
