...
- (void)setupDefault
{
    // 1.设置数据的默认值
    _title             = nil;
    _font1              = [UIFont systemFontOfSize:17];
...
- (void)setHeightPicker:(CGFloat)heightPicker
{
    ...
    self.pickerView.st_height = heightPicker - self.lineView.st_bottom;
}
...
//        [_buttonLeft addBorderColor:self.borderButtonColor];
        [_buttonLeft.titleLabel setFont:_font1];
...
- (UIButton *)buttonRight
{
    if (!_buttonRight) {
        ...
        [_buttonRight.titleLabel setFont:_font1];
